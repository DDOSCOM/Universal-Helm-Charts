...
readonly CHART_RELEASER_VERSION=1.4.0
...
sudo ln -sfn "/usr/local/helm-v$HELM_VERSION/linux-amd64/helm" /usr/local/bin/helm
...
sudo ln -sfn "/usr/local/chart-releaser-v$CHART_RELEASER_VERSION/chart-releaser" /usr/local/bin/chart-releaser
